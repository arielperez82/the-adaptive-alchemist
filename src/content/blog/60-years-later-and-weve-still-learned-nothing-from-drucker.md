...
Drucker's core insight feels almost absurd in its simplicity: _"The executive is, first of all, expected to get the right things done."_ Not manage people. Not optimize processes. Get the right things done. That's it.

What floored me was that Drucker defined "executive" as anyone who makes decisions that affect organizational performance. Engineers deciding technical architecture? Executives. Product managers prioritizing features? Executives. Data scientists building models? All executives.
...
Drucker writes: _"Time is the scarcest resource and unless it is managed nothing else can be managed."_ He then describes executives who think they know where their time goes but are completely wrong when they actually track it.
...
This isn't productivity porn. It's the foundation of effective leadership. Yet most leaders I know couldn't tell you how they spent last Thursday if their life depended on it.

## The contribution mindset

Here's where Drucker gets really dangerous. He argues that effective executives focus outward on contribution, not inward on their own efforts. They ask _"What can I contribute?"_ instead of _"What's in it for me?"_
...
Every [fluid organization](/the-paradox-of-fluid-teams-familiar-yet-revolutionary/) I've worked with operates exactly this way. People join mission teams based on what they can contribute, not what they can extract. Teams form around customer problems, not career advancement. It works because contribution thinking scales better than self-interest.

Drucker figured this out when Kennedy was president. We're still barely catching up.
...
This is where I respectfully push back on Drucker, if only to adjust for today's AI-accelerated, [VUCA](https://en.wikipedia.org/wiki/VUCA) world. While his premise about cross-functional teams of people with exceptional strengths remains solid, a team of pure specialists won't cut it anymore. With AI agents taking over routine work and smaller teams becoming the norm, we need [M-shaped people](https://portera.nl/m-shaped-people/): those with deep expertise in multiple domains plus broad capabilities across others.
...
The crazy part is that every successful organizational transformation I've seen, from [FAST](/choosing-your-fluid-organization-approach/#fast-fluid-adaptive-scaling-technology) teams to [Operations Squads](/from-one-team-to-many-part-3-the-stability-engine/#introducing-the-operations-squad-model) to [shared consciousness](/shared-consciousness-and-breaking-the-decision-bottleneck/#what-is-shared-consciousness) follows Drucker's principles. We just dress them up in modern language and pretend we invented something new.
